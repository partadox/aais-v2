<!-- Modal -->
<div class="modal fade" id="modaltambahlevel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <?= form_open('level/create', ['class' => 'formtambah']) ?>
            <?= csrf_field(); ?>
