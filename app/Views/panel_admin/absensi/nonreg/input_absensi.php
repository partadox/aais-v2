...
<div class="modal fade" id="modaltm" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <?= form_open('absensi-nonreg/save', ['class' => 'formtambah',  'enctype' => 'multipart/form-data']) ?>
            <?= csrf_field(); ?>
            ...
            <input type="hidden" name="npjId" value="<?= $npjId ?>">
            <div class="modal-body">
                <h5><code>Anda Mengisi Absensi Sebagai: <?= $pengajar['nama_pengajar'] ?></code></h5>
