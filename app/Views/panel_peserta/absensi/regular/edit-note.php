...
<div class="modal fade" id="modalNote" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <?= form_open('/peserta/absensi-regular-updatenote', ['class' => 'formedit']) ?>
            <?= csrf_field(); ?>
            <div class="modal-body">
                <input type="hidden" class="form-control" name="absen_peserta_id" id="absen_peserta_id" value="<?= $absen_peserta_id ?>"  readonly>
                <input type="hidden" class="form-control" name="note_ps_tm" id="note_ps_tm" value="<?= $note_ps_tm ?>"  readonly>
