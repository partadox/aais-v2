...
<div class="modal fade" id="modalNote" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <?= form_open('/peserta/absensi-bina-updatenote', ['class' => 'formedit']) ?>
            <?= csrf_field(); ?>
            <div class="modal-body">
                <input type="hidden" class="form-control" name="bas_id" id="bas_id" value="<?= $bas['bas_id'] ?>"  readonly>
...
<script>
    $(document).ready(function() {
        $('#bas_note').val('<?= htmlentities($bas['bas_note'])?>');
