                        ...
                        <div class="col-sm-8">
                            <div class="input-group" id="datepicker2">
                                <input type="text" id="bas_tm_dt" name="bas_tm_dt" class="form-control" placeholder="Tahun-Bulan-Tanggal"
                                    ...
                                    data-provide="datepicker" data-date-autoclose="true" value="<?= isset($bs['bas_tm_dt']) ? substr($bs['bas_tm_dt'], 0, 10) : date("Y-m-d") ?>">
                        ...
                        <table class="table table-striped table-bordered nowrap mt-1" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <input type="radio" name="check" value="1" <?php if (isset($bs['bas_absen']) && $bs['bas_absen'] == '1') echo 'checked'; ?>>
                                    </td>
                                    <td>
                                        <input type="radio" name="check" value="0" <?php if (isset($bs['bas_absen']) && $bs['bas_absen'] == '0') echo 'checked'; ?>>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
