...
class Model_nonreg_absen_peserta extends Model
{
    ...
    {
        return $this->table('nonreg_absen_peserta')
            ->select('nonreg_absen_peserta.*, nonreg_peserta.np_nama, nonreg_kelas.nk_id, nonreg_kelas.nk_nama, nonreg_kelas.nk_angkatan, nonreg_kelas.nk_pic_name, nonreg_kelas.nk_tahun')
